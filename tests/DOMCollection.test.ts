...
describe('DOMCollection plugin for object properties', () => {
    ...
    it('supports config.min option', () => {
        ...
        expect(el.attributes).toPrettyPrintTo('{"name1": "value1", "name2": "value2"}', { min: true });
    });
});
...
describe('DOMCollection plugin for list items', () => {
    ...
    const expectedNodeList = ['NodeList [', expectedOption1, expectedOption2, expectedOption3, ']'].join('\n');
